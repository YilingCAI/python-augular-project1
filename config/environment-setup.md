...
- Staging: `../mypythonproject1-infra/envs/staging.tfvars` + GitHub Environment `staging`
- Production: `../mypythonproject1-infra/envs/prod.tfvars` + GitHub Environment `production`
...
1. Configure `../mypythonproject1-infra/envs/staging.tfvars`
...
1. Configure `../mypythonproject1-infra/envs/prod.tfvars`
